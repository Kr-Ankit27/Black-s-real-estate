...
const Testimonails = () => {
  return (
    ...
    initial={{ opacity: 0, x: 100 }}
      ...
      viewport={{ once: true }}
    className='container mx-auto p-10 lg:px-32 w-full overflow-hidden' id='Testimonials'>

      <h1 className='text-2xl sm:text-4xl font-bold mb-2 
      text-center'>Customers <span className='underline underline-offset-4 decoration-1 under font-light'>Testimonails</span></h1>
