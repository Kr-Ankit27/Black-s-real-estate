  ...
  return (
    <div  className='pt-10 px-4 md:px-20 lg:px-32 bg-gray-900 w-full overflow-hidden' id='Footer'>
      <div className='container mx-auto flex flex-col md:flex-row justify-between items-start '>
        <div className='w-full md:w-1/3  mb-8 md:mb-0'>
            ...
            <p className='text-gray-400 mt-4'>Lorem ipsum dolor sit, amet consectetur adipisicing elit.
                 Adipisci itaque accusantium qui, nisi quo voluptatibus! 
                 Officia suscipit, amet temporibus sint iste nisi
                 </p>
        </div>
        ...
        <div className='w-full md:w-1/3'>
            ...
            <p className='text-gray-400 mb-4 max-w-80'>Stay updated with the latest news and offers.</p>
      ...
      <div className='border-t border-gray-700 mt-10 py-4 text-center text-gray-500'>
        © 2025 Black Love. All Rights Reserved.
      </div>
    </div>
  )
}
